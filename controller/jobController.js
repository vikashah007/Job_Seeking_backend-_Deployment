...
export const postJob=catchAsyncError(async(req,res,next)=>{
    ...
    if((!salaryFrom || !salaryTo) && !fixedSalary)
        {
            return next(new ErrorHandler("Either provide fixed salary or provide ranged salary ",400))
        }
    if(salaryFrom && salaryTo && fixedSalary)
        {
            return next(new ErrorHandler("Cannot enter fixed salary and ranged salary togather",400))
        }
